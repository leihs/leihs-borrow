...
LEIHS_LEGACY_HTTP_BASE_URL = ENV['LEIHS_LEGACY_HTTP_BASE_URL'].presence || "http://localhost:3210"
LEIHS_LEGACY_HTTP_PORT =  Addressable::URI.parse(LEIHS_LEGACY_HTTP_BASE_URL).port.presence  || '3210'
