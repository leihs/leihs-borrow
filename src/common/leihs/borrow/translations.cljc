...
(def dict
  ...
  ; --- PER COMPONENT TRANSLATIONS (reused between some features) ---
    ...
    {:label {:quantity {:en-GB "Quantity" :de-CH "Anzahl" :fr-CH "Quantité"}
             ...
             :pool-max-amount {:en-GB "{pool} (max. {amount, number})"
                               :de-CH "{pool} (max. {amount, number})"
                               :fr-CH "{pool} (max. {amount, number})"}
             :pool-max-amount-info {:en-GB  "Maximum available amount: {amount, number}"
                                    :de-CH "Maximal verfügbarer Bestand: {amount, number}"
                                    :fr-CH "Quantité maximale disponible : {amount, number}"}
             ...
             :show-day-quants {:en-GB "Show availability in calendar"
                               :de-CH "Verfügbarkeit im Kalender anzeigen"
                               :fr-CH "Afficher la disponibilité dans le calendrier"}}
  ...
  ; --- PER FEATURE TRANSLATIONS ---
    ...
    :model-show {:loading {:en-GB "Loading item"
                 ...
                 :order-success-notification {:title {:en-GB "Item added" :de-CH "Gegenstand hinzugefügt" :fr-CH "Élément ajouté"}
                                              :item-was-added {:en-GB "The item was added to the cart"
                                                               :de-CH "Der Gegenstand wurde zum Warenkorb hinzugefügt"
                                                               :fr-CH "L’élément a été ajouté au panier"}}}
    ...
    :rentals {:title {:en-GB "Orders"
              ...
              :filter  {:pools {:title {:en-GB "Inventory pools"
                                        :de-CH "Inventarparks"
                                        :fr-CH "Pools d’inventaire"}
                                :all {:en-GB "All inventory pools"
                                      :de-CH "Alle Inventarparks"
                                      :fr-CH "Tous les pools d’inventaire"}
                                :invalid-option {:en-GB "Invalid selection"
                                                 :de-CH "Ungültige Auswahl"
                                                 :fr-CH "Sélection invalide"}
                        ...
                        :js-component {:search-button-label {:en-GB "Search" :de-CH "Suchen" :fr-CH "Rechercher"}
                                       ...
                                       :timespan-label {:en-GB "{startDate, date, narrow} – {endDate, date, narrow}"
                                                        :de-CH "{startDate, date, narrow} – {endDate, date, narrow}"
                                                        :fr-CH "{startDate, date, narrow} – {endDate, date, narrow}"}
                                       :timespan-label-from {:en-GB "{startDate, date, narrow} – "
                                                             :de-CH "{startDate, date, narrow} – "
                                                             :fr-CH "{startDate, date, narrow} – "}
                                       :timespan-label-until {:en-GB " – {endDate, date, narrow}"
                                                              :de-CH " – {endDate, date, narrow}"
                                                              :fr-CH " – {endDate, date, narrow}"}
                                       :timespan-unrestricted {:en-GB "Timespan from/until"
              ...
              :fulfillment-state-label {; states flowchart
                                        ...
                                        :RETURNED {:de-CH "Alle Gegenstände zurückgebracht"
                                                   :en-GB "All items returned"
                                                   :fr-CH "Tous les éléments ont été retournés"}
                                        :REJECTED {:de-CH "Bestellung wurde abgelehnt"
                                                   :en-GB "Order was rejected"
                                                   :fr-CH "La commande a été refusée"}
                                        :EXPIRED-UNAPPROVED {:de-CH "Abgelaufen (nicht genehmigt)"
                                                             :en-GB "Expired (not approved)"
                                                             :fr-CH "Expiré (non approuvé)"}
                                        :CANCELED {:de-CH "Bestellung wurde storniert"
                                                   :en-GB "Order was canceled"
                                                   :fr-CH "La commande a été annulée"}
                                        :EXPIRED {:de-CH "Abgelaufen (nicht abgeholt)"
                                                  :en-GB "Expired (not picked up)"
                                                  :fr-CH "Expiré (non retiré)"}
                                        :OVERDUE {:de-CH "Rückgabe überfällig"
                                                  :en-GB "Overdue"
                                                  :fr-CH "Retour en retard"}}
              ...
              {:open {:de-CH "{totalDays, plural,
               ...
               {:summary-line
                ...
                :partial-status {:REJECTED {:de-CH " ({count} abgelehnt)"
                                            :en-GB " ({count} rejected)"
                                            :fr-CH " ({count} refusé)"}
                                 :EXPIRED {:de-CH " ({count} abgelaufen)"
                                           :en-GB " ({count} expired)"
                                           :fr-CH " ({count} expiré)"}
