(ns leihs.borrow.html
  (:require [leihs.core.http-cache-buster2 :as cache-buster]
            ...
            #_[ring.util.response :refer
               [resource-response content-type status]]))
...
(defn head
  ...
  [:head [:meta {:charset "utf-8"}]
   ...
   (hiccup.page/include-css (cache-buster/cache-busted-path
                              "/app/borrow/css/styles/base-styles.css"))
   (hiccup.page/include-css (cache-buster/cache-busted-path
                              "/app/borrow/css/styles/app-styles.css"))])
                 ...
                 [:div#app
                  [:noscript
                   [:div.p-4.text-monospace
                    ...
                    [:p.italic.font-black.text-red-800
