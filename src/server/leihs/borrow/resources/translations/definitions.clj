  ...
  {:en-GB {:borrow {:all "All"
   ...
   :de-CH {:borrow {:all "Alle"
                    ...
                    :shopping-cart {:title "Warenkorb"
                                    ...
                                    :order-title "Name der Bestellung"
                                    :order-title-placeholder "Benenne deine Bestellung"
                                    :order-purpose "Zweck der Bestellung"
                                    :order-purpose-placeholder "Gebe einen Zweck ein"}
