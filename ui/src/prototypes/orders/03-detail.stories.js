...
function OrderDetail({ order, onOrderCancelClick, onItemClick }) {
  return (
    <PageLayoutMock>
          ...
          <ListCard.Stack>
            {order.models.map(({ reservation, model, pool, pickupLocation }, i) => (
              <ReservationCard
                ...
                poolName={pool.name}
                locationName={pickupLocation && pickupLocation.name}
...
const sampleOrderWithoutPickupLocations = {
  ...sampleOrderBase,
  models: [
    {
      reservation: {
...
const sampleOrderWithPickupLocations = {
  ...sampleOrderBase,
  models: [
    {
      reservation: {
...
export const detail = ({ order, onOrderCancelClick, onItemClick }) => (
  <OrderDetail order={order} onOrderCancelClick={onOrderCancelClick} onItemClick={onItemClick} />
)
detail.storyName = 'Without pickup locations'
detail.args = {
  order: sampleOrderWithoutPickupLocations,
  onOrderCancelClick: action('order-cancel'),
  onItemClick: action('item-click')
}

export const detailWithPickupLocations = ({ order, onOrderCancelClick, onItemClick }) => (
  <OrderDetail order={order} onOrderCancelClick={onOrderCancelClick} onItemClick={onItemClick} />
)
detailWithPickupLocations.storyName = 'With pickup locations'
detailWithPickupLocations.args = {
  order: sampleOrderWithPickupLocations,
  onOrderCancelClick: action('order-cancel'),
  onItemClick: action('item-click')
}
