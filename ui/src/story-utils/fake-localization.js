...
export const orderPanelTexts = {
  label: {
    ...
    'pickup-location': { 'de-CH': 'Pickup location' },
    'pickup-locations-more-details': {
      'de-CH': 'More details about the alternative pickup locations'
    },
    'main-warehouse': { 'de-CH': 'Hauptstandort' },
    'not-transportable': {
